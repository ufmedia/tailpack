...
/* harmony import */ var tw_elements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tw-elements */ "./node_modules/tw-elements/dist/js/index.min.js");
/* harmony import */ var tw_elements__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(tw_elements__WEBPACK_IMPORTED_MODULE_3__);

 //npm install axios
 //npm install axios-retry

const url = 'https://wtwcinemas.co.uk/wp-json/wp/v2/';
let page = 1;
let feed = [];
const myIcon = new Image();
myIcon.src = MyImage;
document.querySelector('.imageFrame').appendChild(myIcon);
...
const getInitialFeed = async () => {
  try {
    let response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url + 'film?per_page=100&page=' + page, {
      headers: {
    ...
    if (response.headers['x-wp-totalpages'] > page) {
      while (response.headers['x-wp-totalpages'] > page) {
        page++;
        response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url + 'film?per_page=100&page=' + page, {
          headers: {
            'content-type': 'text/json'
          }
        });
...
const render = async () => {
  ...
  feed.map(async function (item) {
    try {
      let response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url + 'media/' + item.acf.image, {
        headers: {
          'content-type': 'text/json'
        }
      });
...
<a href="#">
    <img class="rounded-t-lg" src="${response.data.source_url}" alt="${response.data.alt_text}">
</a>
<div class="p-5">
    <a href="#">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${item.title.rendered}</h5>
    </a>
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">${item.acf.synopsis}</p>
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwptailpack"] = self["webpackChunkwptailpack"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-index"], function() { return __webpack_require__("./public/src/js/index.js"); })
